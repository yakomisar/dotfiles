...
-- 		-- белые скобки
-- 		vim.cmd([[highlight @punctuation.bracket.go guifg=#ebdbb2]])
-- 		-- <> == = != <= >= & *
-- 		-- vim.cmd([[highlight @lsp.type.operator.go guifg=#ebdbb2]])
-- 		-- StatusLine colors
-- 		vim.cmd([[highlight StatusLineMode guifg=#ebdbb2 guibg=#282828 gui=bold]]) -- Mode color, Gruvbox foreground on dark background
-- 		vim.cmd([[highlight StatusLineGitBranchIcon guifg=#fe8019 guibg=#282828]]) -- Orange icon for Git branch
-- 		vim.cmd([[highlight StatusLineLspActive guifg=#b8bb26 guibg=#282828]]) -- Green for active LSP
-- 		vim.cmd([[highlight StatusLineLspError guifg=#fb4934 guibg=#282828]]) -- Red for errors
-- 		vim.cmd([[highlight StatusLineLspWarn guifg=#fabd2f guibg=#282828]]) -- Yellow for warnings
-- 		vim.cmd([[highlight StatusLineLspHint guifg=#8ec07c guibg=#282828]]) -- Aqua for hints
-- 		vim.cmd([[highlight StatusLineLspInfo guifg=#83a598 guibg=#282828]]) -- Blue for info
-- 		vim.cmd([[highlight StatusLineMedium guifg=#ebdbb2 guibg=#282828]]) -- Default text
-- 		vim.cmd([[highlight StatusLineGitDiffAdded guifg=#b8bb26 guibg=#282828]]) -- Green for added lines
-- 		vim.cmd([[highlight StatusLineGitDiffChanged guifg=#fabd2f guibg=#282828]]) -- Yellow for changed lines
-- 		vim.cmd([[highlight StatusLineGitDiffRemoved guifg=#fb4934 guibg=#282828]]) -- Red for removed lines
-- 	end,
-- }
-- }
return {
