...
return {
	...
	-- 				variables = false,
	-- 			},
	-- 			contrast = "soft", -- варианты: "hard", "soft", ""
	-- 			palette_overrides = {
	-- 				-- Можно переопределить цвета при необходимости
	-- 				dark0 = "#282828",
	-- 				dark1 = "#3c3836",
	-- 				dark2 = "#504945",
	-- 				dark3 = "#665c54",
	...
	-- 		-- vim.api.nvim_set_hl(0, "StatusLineMode", { fg = colors.text, bg = "#282828", bold = true })
	-- 		-- vim.api.nvim_set_hl(0, "StatusLineMedium", { fg = colors.text, bg = "#282828" })
	-- 		-- vim.api.nvim_set_hl(0, "StatusLineLspActive", { fg = colors.green, bg = "#282828" })
	-- 		-- vim.api.nvim_set_hl(0, "StatusLineLspError", { fg = colors.red, bg = "#282828" })
	-- 		-- vim.api.nvim_set_hl(0, "StatusLineLspWarn", { fg = "#fabd2f", bg = "#282828" })
	-- 		-- vim.api.nvim_set_hl(0, "StatusLineLspHint", { fg = "#8ec07c", bg = "#282828" })
	-- 		-- vim.api.nvim_set_hl(0, "StatusLineLspInfo", { fg = colors.blue, bg = "#282828" })
	-- 		-- vim.api.nvim_set_hl(0, "StatusLineLspMessages", { fg = "#d5c4a1", bg = "#282828" })
	-- 		-- vim.api.nvim_set_hl(0, "StatusLineGitDiffAdded", { fg = colors.green, bg = "#282828" })
	-- 		-- vim.api.nvim_set_hl(0, "StatusLineGitDiffChanged", { fg = colors.yellow, bg = "#282828" })
	-- 		-- vim.api.nvim_set_hl(0, "StatusLineGitDiffRemoved", { fg = colors.red, bg = "#282828" })
	-- 		-- vim.api.nvim_set_hl(0, "StatusLineGitBranchIcon", { fg = "#fe8019", bg = "#282828" })
	-- 		-- vim.api.nvim_set_hl(0, "StatusLineFileName", { fg = colors.text, bg = "#282828" })
	-- 	end,
	-- },
}
