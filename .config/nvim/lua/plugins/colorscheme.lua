return {
    ...
    --
    --         -- vim.cmd([[highlight SnacksPickerInput guibg=#b4ebbc guifg=#212031]])
    --
    ...
    -- },
    {
        ...
        config = function()
            ...
            -- пробуем подтянуть палитру от темы
            local ok, vscode_colors = pcall(require, "vscode.colors")
            if not ok then
                return
            end
            ...
            -- базовые линии
            hl("StatusLine", { fg = c.vscFront, bg = c.vscBack })
            hl("StatusLineNC", { fg = c.vscGray, bg = c.vscBack })

            -- режим
            hl("StatusLineMode", { fg = c.vscBack, bg = c.vscBlue, bold = true })

            -- средние элементы
            hl("StatusLineMedium", { fg = c.vscGray, bg = c.vscBack })
            hl("StatusLineFileName", { fg = c.vscFront, bg = c.vscBack, bold = true })

            -- git
            hl("StatusLineGitBranchIcon", { fg = c.vscYellow, bg = c.vscBack, bold = true })
            hl("StatusLineGitDiffAdded", { fg = c.vscGitAdded, bg = c.vscBack })
            hl("StatusLineGitDiffChanged", { fg = c.vscGitModified, bg = c.vscBack })
            hl("StatusLineGitDiffRemoved", { fg = c.vscGitDeleted, bg = c.vscBack })

            -- LSP
            hl("StatusLineLspActive", { fg = c.vscGreen, bg = c.vscBack, bold = true })
            hl("StatusLineLspMessages", { fg = c.vscLightBlue, bg = c.vscBack })

            hl("StatusLineLspError", { fg = c.vscRed, bg = c.vscBack, bold = true })
            hl("StatusLineLspWarn", { fg = c.vscYellow, bg = c.vscBack, bold = true })
            hl("StatusLineLspInfo", { fg = c.vscLightBlue, bg = c.vscBack })
            hl("StatusLineLspHint", { fg = c.vscBlueGreen, bg = c.vscBack })
        end,
    },
