...
-- buffer management
keymap.set("n", "<leader>nt", ":tabnew<CR>", { noremap = true, silent = true }) -- open new tab
...
-- Terminal Keybinds
----------------------
keymap.set("n", "<leader>t", ":botright split | terminal<CR>", { noremap = true, silent = true })
----------------------
-- Plugin Keybinds
----------------------
...
keymap.set("t", "<leader>x", "<C-\\><C-n>:bd!<CR>", { noremap = true, silent = true })
---------------------
-- Gopher Keymaps
---------------------
...
--
-- -- Add json struct tags
-- keymap.set("n", "<leader>aj", "<cmd>GoTagAdd json<cr>", { noremap = true, silent = true })
--
-- -- Add yaml struct tags
-- keymap.set("n", "<leader>ay", "<cmd>GoTagAdd yaml<CR>", { noremap = true, silent = true })
--
-- -- Remove tags (json/yaml) from struct
-- keymap.set("n", "<leader>rt", "<cmd>GoTagRm json,yaml<CR>", { noremap = true, silent = true })
--
-- -- Add if err check
-- keymap.set("n", "<leader>ie", "<cmd>GoIfErr<CR>", { noremap = true, silent = true })
--
-- -- Generate Method for a struct
-- keymap.set("n", "<leader>gm", "<cmd>GoGenerateMethod<CR>", { noremap = true, silent = true })
--
-- -- Rename a variable or method
-- keymap.set("n", "<leader>rn", "<cmd>GoRename<CR>", { noremap = true, silent = true })
--
-- -- List all usages of a symbol
-- keymap.set("n", "<leader>lu", "<cmd>GoListUsages<CR>", { noremap = true, silent = true })
--
-- -- Run go tests
-- keymap.set("n", "<leader>gt", "<cmd>GoTest<CR>", { noremap = true, silent = true })
--
-- -- Show the type of a variable
-- keymap.set("n", "<leader>tv", "<cmd>GoType<CR>", { noremap = true, silent = true })
