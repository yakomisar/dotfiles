...
-- 	vim.cmd([[highlight CursorLineNr guibg=None guifg=#ffffff gui=bold,italic]])
-- 	vim.cmd([[highlight GitSignsChange guifg=#ff6b1d]])
-- 	vim.cmd([[highlight Visual ctermbg=lightblue guibg=#A7E8AD guifg=#242437 gui=bold cterm=bold]])
-- 	vim.cmd([[highlight VirtualTextError guifg=#F52F27]])
-- 	vim.cmd([[highlight ErrorFloat ctermfg=167 guifg=#F52F27]])
-- end,
